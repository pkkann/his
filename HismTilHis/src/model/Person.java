...
public class Person {
    ...
    public Person(String firstname, String middlename, String lastname, String address, ADate birthdayDate, ADate creationDate, ADate expirationDate, boolean oneOne, boolean hoene) {
        this.firstname = firstname;
        this.middlename = middlename;
        this.lastname = lastname;
        this.address = address;
